xdescribe('The Tip Calculator', function() {
    ...
    it('calculates the bill tip, GIVEN a tip percentage of 15%', function() {
        ...
        tip = sampleApp6.tipCalculator(subtotal, tipPercentage);
...
xdescribe('The Total Calculator', function() {
    ...
    it('calculates the bill total, GIVEN a tip percentage of 15%', function() {
        ...
        total = sampleApp6.totalCalculator(subtotal, tipPercentage);
...
xdescribe('The Total Splitter', function() {
    ...
    //     // spyOn(sampleApp6, 'sendReceipts');

    //     totalEach = sampleApp6.totalSplitter(subtotal, tipPercentage, people);
    ...
    //     expect(sampleApp6.sendReceipts).toHaveBeenCalled();
    // });
